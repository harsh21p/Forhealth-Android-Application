...
public class BluetoothChatService {
    ...
    private synchronized void updateUserInterfaceTitle() {
        ...
        mHandler.obtainMessage(com.example.forhealth.bluetooth.Constants.MESSAGE_STATE_CHANGE, mNewState, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(com.example.forhealth.bluetooth.Constants.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(com.example.forhealth.bluetooth.Constants.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(com.example.forhealth.bluetooth.Constants.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(com.example.forhealth.bluetooth.Constants.TOAST, "Unable to connect");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(com.example.forhealth.bluetooth.Constants.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(com.example.forhealth.bluetooth.Constants.TOAST, "Connection lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                try {
                    ...
                    mHandler.obtainMessage(com.example.forhealth.bluetooth.Constants.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(com.example.forhealth.bluetooth.Constants.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
